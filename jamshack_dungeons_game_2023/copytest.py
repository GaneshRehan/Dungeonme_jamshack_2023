...
def proceed():
  ...
  All the Best!!!""", align="center", font=("Arial", 60, "bold"))
    time.sleep(3)
    pen.clear()
    global press_enter
    press_enter = True
    pen.write("Escape from your enemies and GO GRAB your treasures!!!", align="center", font=("Arial", 40, "bold"))
    time.sleep(3)
    pen.clear()
...
pen.goto(0,-100)
pen.color("gold")
pen.write("Press Enter key to continue", align="center", font=("Arial", 30, "bold"))
pen.goto(0,-200)
pen.color("red")
pen.write("This game is developed by Ganesh Rajapatruni and Jyotishka Deb", align="center", font=("Arial", 30, "bold"))
